...
/**
 * HierarchyLevel11 entity. @author MyEclipse Persistence Tools
 */

public class HierarchyLevel11 implements java.io.Serializable {
	...
	/** default constructor */
	public HierarchyLevel11() {
	}

	/** minimal constructor */
	public HierarchyLevel11(Integer level11Id) {
		this.level11Id = level11Id;
	}

	/** full constructor */
	public HierarchyLevel11(Integer level11Id, String level11Name,
