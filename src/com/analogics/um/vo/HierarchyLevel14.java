...
/**
 * HierarchyLevel14 entity. @author MyEclipse Persistence Tools
 */

public class HierarchyLevel14 implements java.io.Serializable {
	...
	/** default constructor */
	public HierarchyLevel14() {
	}

	/** minimal constructor */
	public HierarchyLevel14(Integer level14Id) {
		this.level14Id = level14Id;
	}

	/** full constructor */
	public HierarchyLevel14(Integer level14Id, String level14Name,
