...
/**
 * HierarchyLevel12 entity. @author MyEclipse Persistence Tools
 */

public class HierarchyLevel12 implements java.io.Serializable {
	...
	/** default constructor */
	public HierarchyLevel12() {
	}

	/** minimal constructor */
	public HierarchyLevel12(Integer level12Id) {
		this.level12Id = level12Id;
	}

	/** full constructor */
	public HierarchyLevel12(Integer level12Id, String level12Name,
