...
/**
 * LoadSurveyLatest entity. @author MyEclipse Persistence Tools
 */

public class LoadSurveyLatest extends HierarchyLevelsVo implements java.io.Serializable {
	...
	/** default constructor */
	public LoadSurveyLatest() {
	}

	/** minimal constructor */
	public LoadSurveyLatest(String meterNumber, Timestamp intervalDateTime,
			Date intervalDate, Timestamp meterDateTime, Date meterDate) {
	...
	/** full constructor */
	public LoadSurveyLatest(String meterNumber, Timestamp intervalDateTime,
			Date intervalDate, Time intervalTime, Integer intervalNo,
