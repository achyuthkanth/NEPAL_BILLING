...
public class LoadSurvey  extends HierarchyLevelsVo implements java.io.Serializable {
	...
	/** minimal constructor */
	public LoadSurvey(LoadSurveyId id, Date intervalDate,
	...
	/** full constructor */
	public LoadSurvey(LoadSurveyId id, Date intervalDate, Time intervalTime,
			Integer intervalNo, Timestamp meterDateTime, Date meterDate,
			Time meterTime, String activeEnergy, String activeEnergyImport,
	...
	public LoadSurveyId getId() {
		return this.id;
	}

	public void setId(LoadSurveyId id) {
		this.id = id;
	}
