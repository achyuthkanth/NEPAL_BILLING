...
/**
 * AlarmData entity. @author MyEclipse Persistence Tools
 */

public class AlarmData extends HierarchyLevelsVo implements java.io.Serializable {

	// Fields

	
	private static final long serialVersionUID = 1L;
	private AlarmDataId id;
	...
	/** minimal constructor */
	public AlarmData(AlarmDataId id, Date nodeDate, String meterNumber,
			Timestamp meterDateTime, Date meterDate, Timestamp alarmDate) {
		this.id = id;
	...
	/** full constructor */
	public AlarmData(AlarmDataId id, Date nodeDate, Time nodeTime,
			String meterNumber, Timestamp meterDateTime, Date meterDate,
			Time meterTime, Timestamp alarmDate, Timestamp insertedDate,
			String alarmCode, String alarmDescription, String sequenceNumber) {
		this.id = id;
		this.nodeDate = nodeDate;
	...
	public AlarmDataId getId() {
		return this.id;
	}

	public void setId(AlarmDataId id) {
		this.id = id;
	}
