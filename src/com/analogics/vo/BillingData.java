...
/**
 * BillingData entity. @author MyEclipse Persistence Tools
 */

public class BillingData extends HierarchyLevelsVo implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = 1030950394537357018L;
	...
	/** minimal constructor */
	public BillingData(BillingDataId id, Date mdresetDate, Integer mdresetYear,
			Integer mdresetMonth, Timestamp meterDateTime, Date meterDate) {
		this.id = id;
	...
	/** full constructor */
	public BillingData(BillingDataId id, Date mdresetDate, Time mdresetTime,
			Integer mdresetYear, Integer mdresetMonth, Integer intervalNo,
