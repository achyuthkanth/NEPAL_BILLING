...
/**
 * DailySnapshotLatest entity. @author MyEclipse Persistence Tools
 */

public class DailySnapshotLatest  extends HierarchyLevelsVo implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = 3505599466297961919L;
	...
	/** default constructor */
	public DailySnapshotLatest() {
	}

	/** minimal constructor */
	public DailySnapshotLatest(String meterNumber, Timestamp snapshotDateTime,
			Date snapshotDate, Timestamp meterDateTime, Date meterDate) {
	...
	/** full constructor */
	public DailySnapshotLatest(String meterNumber, Timestamp snapshotDateTime,
			Date snapshotDate, Time snapshotTime, Timestamp meterDateTime,
			Date meterDate, Time meterTime, Integer intervalNo,
			String activeEnergy, String activeEnergyImport,
			String activeEnergyExport, String activeEnergyCombinedTotal,
			String activeEnergyNetTotal, String reactiveEnergy,
			String reactiveEnergyImport, String reactiveEnergyExport,
			String apparentEnergy, String apparentEnergyImport,
			String apparentEnergyExport, String activeDemand,
