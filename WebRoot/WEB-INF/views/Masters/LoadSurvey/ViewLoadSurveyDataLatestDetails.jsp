		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Load Survey Latest</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active">Load Survey Latest</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="container-fluid">
							...
							<div class="card card-default">
								<div class="card-header">
									<h3 class="card-title">Load Survey Latest Details</h3>
...
// 							alert("showColumns "+showColumns);
							...
							var table = $table.DataTable({
								...
								"sAjaxSource": "fetchLoadSurveyDataLatestDetails?" + url,
								  "aoColumns": [
         	{
	                 "mData": "id",
	                 "defaultContent" : "-",
