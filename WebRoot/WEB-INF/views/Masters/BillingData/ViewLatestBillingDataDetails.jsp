							...
							<div class="content-wrapper">
								...
								<section class="content-header">
									<div class="container-fluid">
										<div class="row mb-2">
											<div class="col-sm-6">
												<h1>Billing Latest Data </h1> </div>
											<div class="col-sm-6">
												<ol class="breadcrumb float-sm-right">
													<li class="breadcrumb-item"><a href="#">Home</a> </li>
													<li class="breadcrumb-item active">Billing Data Latest</li>
												</ol>
											</div>
										</div>
									</div>
									...
									<div class="container-fluid">
										...
										<div class="card card-default">
											<div class="card-header">
												<h3 class="card-title">Billing Latest Data Information</h3>
								...
								<section class="content">
									<div class="container-fluid">
										<div class="card card-default">
											<div class="card-header">
												<h3 class="card-title">Billing Latest Data Details</h3>
												<div class="card-tools">
...
// 							alert(url);
						...
						function loadDataTable(url) {
							...
							var table = $table.DataTable({
								...
								"sAjaxSource": "fetchLatestBillingDataDetails?" + url,
								"aoColumns": [
						         	{
							                 "mData": "id",
							                 "defaultContent" : "-",
						...
						$('.ExportClass').click(function(){
		    				var searchParameter = "",
								...
								"searchParameter=" + searchParameter + "&" + 
								"conditionStr=" + conditionStr;
		    				var action ="exportLatestBillingData?"+url;
