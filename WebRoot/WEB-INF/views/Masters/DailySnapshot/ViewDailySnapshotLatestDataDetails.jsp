							...
							<div class="content-wrapper">
								...
								<section class="content-header">
									<div class="container-fluid">
										<div class="row mb-2">
											<div class="col-sm-6">
												<h1>Daily Snap Shot Latest</h1> </div>
											<div class="col-sm-6">
										...
										<div class="container-fluid">
											...
											<div class="card card-default">
												<div class="card-header">
													<h3 class="card-title">Daily Snap Shot Latest Details</h3>
														...
														<div class="col-md-3">
															<div class="form-group">
																<div class="" style="margin-top: 20px;">
																	...
																	<button type="button" class="btn btn-danger ExportClass" id="ExportButton">Export </button>
																</div>
															</div>
														</div>
													</div>
																	...
																	<div class="row" id="startingROw">
																		...
																		<div class="col col-md-1">
																			<div class="btn-group" role="group" aria-label="operation">
																				<a class="btn btn-success btn-plus btn-sm" href="#"> <i class="fas fa-plus"> </i> </a>&nbsp; </div>
																		</div>
																	</div>
																</div>
						...
						$(document).ready(function() {
							...
							function loadDataTable(url, hideColumns, showColumns) {
								...
								var table = $table.DataTable({
									...
									"sAjaxSource": "fetchDailySnapshotDataLatestDetails?" + url,
									"aoColumns": [{
											"mData": "id",
											"defaultContent": "-",
											...
											"mData": "activeDemandImport",
											 "defaultContent": "-"
										}, {
											"mData": "activeDemandImportOccTime",
											 "defaultContent": "-"
										}, {
											"mData": "activeDemandExport",
											 "defaultContent": "-"
										}, {
											"mData": "activeDemandExportOccTime",
											 "defaultContent": "-"
										}, {
											"mData": "apparentDemand",
											 "defaultContent": "-"
										}, {
											"mData": "apparentDemandImport",
											 "defaultContent": "-"
										}, {
											"mData": "apparentDemandImportOccTime",
											 "defaultContent": "-"
										}, {
											"mData": "apparentDemandExport",
											 "defaultContent": "-"
										}, {
											"mData": "apparentDemandExportOccTime",
											 "defaultContent": "-"
										},
							...
							$('.ExportClass').click(function() {
								loadDataTable(url, "", "");
								var action = "exportDailySnapshotLatest?" + url;
