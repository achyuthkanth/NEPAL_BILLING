					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Latest Alarm Data</li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="container-fluid">
							...
							<div class="card card-default">
								<div class="card-header">
									<h3 class="card-title">Latest Alarm Data Details</h3>
								...
								<div class="card-body">
									<div class="row">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<div class="rect-check" style="float:left;margin-top:20px;">
											<label class="switch" class="rect-check"> <input
												type="checkbox" id="checkId"> <span
...
<link href="css/date-picker/daterangepicker/daterangepicker-bs3.css" rel="stylesheet">
	...
	<script type="text/javascript">
		...
		alert($('.level3Class').find('option:selected').val()); */
						...
						+ "&" +"searchParameter=" + '${command.searchParameter}' + "&" + "conditionStr=" + '${command.conditionStr}';
						loadDataTable(url, "", "");
...
// 							alert("showColumns "+showColumns);
							...
							var table = $table.DataTable({
								...
								"sAjaxSource": "fetchAlarmLatestDataDetails?" + url,
								  "aoColumns": [
         	{
	                 "mData": "id",
	                 "defaultContent" : "-",
		...
		var isChecked = document.getElementById("checkId").checked;
		  var columns = table.columns(className);
...
// 								url = "searchSelectVar=" + searchSelectVar + "&" + "searchParameter=" + searchParameter + "&" + "conditionStr=" + conditionStr;
						...
						+ "&" +"level8Id="+$('.level8Class').find('option:selected').val() 
						+ "&" +"level9Id="+$('.level9Class').find('option:selected').val() 
						 "&" +"searchParameter=" +searchParameter + "&" + "conditionStr=" + conditionStr;
						loadDataTable(url, "", "");
