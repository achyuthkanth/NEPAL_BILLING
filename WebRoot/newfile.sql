...
insert into hierarchy_level2 (level2_name ,level2_code,level2_uniquecode ,level1_id) values(?,?,?,?)
insert into HierarchyLevel1 (level1Name ,level1Code,level1Uniquecode ) values('NEA1','NEA1','NEA1')
